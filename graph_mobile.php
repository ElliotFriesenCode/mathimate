...
<html>
	...
	<link rel="shortcut icon" href="#">
        ...
        <link rel="stylesheet" href="./styles2_mobile.css">
...
-->
   ...
   <input type="button" class="add-frame hidden" id="plus" value="+" onclick="addFramePressed()">
    ...
    <div class="new-frame-box">
        ...
        <input type="button" value="Duplicate" class="add-frame-box" onclick="duplicateFrame()">
        </div>
        </div>
    </div>
<div class="play-box">
...
<p id="title" class="title">Document Name</p>
    ...
    <div id="menu">
        ...
        <div class="file-box" id="fb2">
            <div class="relative">
        <div class="file-button" onclick="exportbutton()">
        ...
        <div class="file-box">
         ...
         <div class="file-box">
            <div class="relative">
        <div class="file-button1" id="export-button1">
        <p class="file-text">Export</p>
        </div>
...
-->
    ...
    <script src="canvas12_mobile.js"></script>
    </div>
    </div>
